...
todowrite({
  todos: [
    { content: "收集调用上下文", status: "pending", priority: "high" },
    { content: "多维调用点分析", status: "pending", priority: "high" }
  ]
})
...
todowrite({ todos: [{ content: "收集调用上下文", status: "completed", priority: "high" }] })
todowrite({ todos: [{ content: "多维调用点分析", status: "pending", priority: "high" }] })
...
todowrite({ todos: [{ content: "多维调用点分析", status: "completed", priority: "high" }] })
