...
来源缩写（以下报告均位于作者内部 hashmap-0902 优化仓库，未随本仓库分发）：

| 缩写 | 报告 |
|---|---|
| CUCKOO | CUCKOO_OPTIMIZATION_SUMMARY.md |
| SWISS | SWISS_KPPERF_BOTTLENECK_REPORT.md |
| F14 | F14_MICROARCHITECTURE_ANALYSIS_REPORT.md |
| LOCKFREE | CUCKOO_READ_PATH_LOCKFREE_KPPERF_REPORT.md |
| F14_SHARD | F14_SHARD_GAIN_MECHANISM_REPORT.md |
| CUCKOO_Q | CUCKOO_QUERY_OPTIMIZATION_REPORT.md |
| CUCKOO_R2 | CUCKOO_QUERY_OPTIMIZATION_R2_REPORT.md |
| CUCKOO_FB | SKILL_FEEDBACK_AND_CYCLE_TIME_REPORT.md |
