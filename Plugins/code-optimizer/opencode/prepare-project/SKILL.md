...
todowrite({
  todos: [
    { content: "验证项目", status: "pending", priority: "high" },
    { content: "提取编译参数", status: "pending", priority: "high" },
    { content: "收集机器信息", status: "pending", priority: "high" },
    { content: "定位目标", status: "pending", priority: "high" },
    { content: "建立基线", status: "pending", priority: "high" },
    { content: "架构分析", status: "pending", priority: "high" }
  ]
})
...
todowrite({ todos: [{ content: "验证项目", status: "completed", priority: "high" }] })
todowrite({ todos: [{ content: "提取编译参数", status: "pending", priority: "high" }] })
...
todowrite({ todos: [{ content: "提取编译参数", status: "completed", priority: "high" }] })
todowrite({ todos: [{ content: "收集机器信息", status: "pending", priority: "high" }] })
...
todowrite({ todos: [{ content: "收集机器信息", status: "completed", priority: "high" }] })
todowrite({ todos: [{ content: "定位目标", status: "pending", priority: "high" }] })
...
todowrite({ todos: [{ content: "定位目标", status: "completed", priority: "high" }] })
todowrite({ todos: [{ content: "建立基线", status: "pending", priority: "high" }] })
...
todowrite({ todos: [{ content: "建立基线", status: "completed", priority: "high" }] })
todowrite({ todos: [{ content: "架构分析", status: "pending", priority: "high" }] })
...
todowrite({ todos: [{ content: "架构分析", status: "completed", priority: "high" }] })
