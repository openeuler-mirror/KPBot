...
**来源缩写**（均位于作者内部 hashmap-0902 优化仓库，未随本仓库分发）：SUMMARY = CUCKOO_OPTIMIZATION_SUMMARY.md；SIMD 报告 = CUCKOO_BUCKET_COMPARE_SIMD_REPORT.md；ARM-LEVERS = CUCKOO_ARM_OPTIMIZATION_LEVERS.md；SWISS 报告 = SWISS_PHMAP_BENCHMARK_REPORT.md；LEV = CUCKOO_OPEN_LEVERS_20260626.md。
