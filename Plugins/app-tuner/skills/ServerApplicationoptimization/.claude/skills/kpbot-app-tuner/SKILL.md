...
description: Claude Code Dynamic Workflows 入口。按门控加载主源 skill，根据性能采集信息动态生成候选优化 skill 列表并调度 workflow，而不是线性执行所有优化分支。主源位于 skills/kpbot-app-tuner/SKILL.md。
---
...
1. 先加载主源 `skills/kpbot-app-tuner/SKILL.md`，再按主源的 Phase 1 强制读取列表加载 references。
